...
<style>
  ...
  /* ====== Toolbar ala Figma: icon calendar + pill dropdown ====== */
  .toolbar{
  ...
  .section-head{
    background:#e6e6e6; border-radius:16px 16px 0 0; padding:10px 16px; font-weight:700; color:#555;
...
<div class="container laporan-wrap mt-3">
  ...
  <div class="toolbar mb-3">
    ...
    <div class="dropdown">
      <button class="pill-select dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <div class="section-card">
    <div class="section-head">List Laporan</div>
